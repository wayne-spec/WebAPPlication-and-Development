...
<div class="col-sm-6">
  <center><h2><?php echo $rows['Hostel_Type'] ?></h2></center>
  <div class="row">
    <div class="col-sm-6">
      ...
      <div class="col-sm-6">
          <table>
            ...
            <tr>
              <td><h3>SubCounty:</h3></td>
              <td><h4><?php echo $rows['SubCounty']; ?></h4></td>
            </tr>
            <tr>
              <td><h3>Ward:</h3></td>
              <td><h4><?php echo $rows['Ward']; ?></h4></td>
            </tr>
            <tr>
              <td><h3>Street:</h3></td>
            ...
            <tr>
              <td><h3>Estate:</h3></td>
              <td><h4><?php echo $rows['Estate']; ?></h4></td>
            </tr>
            <tr>
    ...
    <div class="col-sm-6">
      <table>
            ...
            <tr>
              <td><h3>Space:</h3></td>
              <td><h4><?php echo $rows['Space']; ?></h4></td>
            </tr>
            <tr>
...
<form method="POST">
  <div class="row">
    <div class="col-sm-6">
      ...
      $space_query = "SELECT space FROM add_Hostel WHERE Hostel_id='$Hostel_id'";
      $space_result = mysqli_query($db, $space_query);
      $space_row = mysqli_fetch_assoc($space_result);
      $space = $space_row['space'];

      $booking_count_query = "SELECT COUNT(*) AS booking_count FROM booking WHERE Hostel_id='$Hostel_id'";
      $booking_count_result = mysqli_query($db, $booking_count_query);
      $booking_count_row = mysqli_fetch_assoc($booking_count_result);
      $booking_count = $booking_count_row['booking_count'];

      if ($space > $booking_count) { ?>
        <input type="hidden" name="Hostel_id" value="<?php echo $Hostel_id; ?>">
        <input type="submit" class="btn btn-lg btn-primary" name="book_Hostel" style="width: 100%" value="Book Hostel">
      <?php } else { ?>
        <input type="submit" class="btn btn-lg btn-primary" style="width: 100%" value="No Space Available" disabled>
      <?php } ?>
    </div>
  </div>
</form>
...
<?php
    ...
    $sql1="SELECT * from review where Hostel_id='$Hostel_id'";
